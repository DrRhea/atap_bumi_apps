...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Get device height to calculate proportions
    final deviceHeight = MediaQuery.of(context).size.height;
    
    return Scaffold(
      backgroundColor: const Color(0xFFB5E0B5), // Light mint green background
      body: SafeArea(
        child: Column(
          children: [
            // Top mint green section (approximately 1/4 of screen)
            Container(
              height: deviceHeight * 0.25, // 1/4 of the screen height
            ...
            // White container with form elements (approximately 3/4 of screen)
            Expanded(
              child: Container(
